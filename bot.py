...
# ============================================================
#  ИИ-ответ с гарантированно рабочими бесплатными моделями
# ============================================================
def ask_ai(question):
    # Список проверенных бесплатных моделей. Если одна недоступна (404/429), бот пробует следующую.
    models_to_try = [
        "minimax/minimax-m3:free",               # Та, что уже работала у тебя
        "meta-llama/llama-3.3-70b-instruct:free", # Мощная и стабильная бесплатная модель
        "mistralai/mistral-7b-instruct:free"      # Классическая надёжная модель
    ]
    ...
    for model in models_to_try:
        try:
                    ...
                    "messages": [
                        {
                            "role": "system", 
                            "content": (
                                "Ты — дружелюбный помощник 'бро' в киноклубе. "
                        ...
                        {
                            "role": "user", 
                            "content": f"Вопрос пользователя (отвечай на русском языке): {question}"
                        }
                    ]
                },
                timeout=30
            ...
            # Если модель не найдена (404) или перегружена (429), пробуем следующую
    ...
    return "⚠️ Все бесплатные модели ИИ временно недоступны. Попробуй написать 'бро' через пару минут!"
# ============================================================
#  МЕНЮ И КОМАНДЫ
# ============================================================
def main_menu_kb():

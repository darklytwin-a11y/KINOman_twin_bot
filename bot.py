...
# ============================================================
def ask_ai(question):
    # Список проверенных бесплатных моделей. Если одна недоступна, бот пробует следующую.
    models_to_try = [
    ...
    for model in models_to_try:
        try:
            ...
            # Любая ошибка (404, 429, таймаут) — просто пробуем следующую модель
            continue
            
    # Если все модели не сработали — вежливое сообщение без технических деталей
